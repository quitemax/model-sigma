...
## Rola w Model Σ
§14, tabela 2×2: sieć trenowana z pomocniczym celem samo-predykcji stanu ukrytego (cel =
*stan wewnętrzny* h_ℓ) — ale aktualizacja jest **zamrożona po treningu**, więc przy wdrożeniu
deskryptywna (g_ℓ ≈ 0). Komórka (cel = stan wewnętrzny) × (tylko trening).
