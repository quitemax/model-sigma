...
- DOI: https://doi.org/10.1371/journal.pcbi.1011465
...
## Rola w Model Σ
Kanoniczne sformułowanie IIT, na którym opiera się szkielet formalny (Φ, aksjomaty/postulaty).
Kluczowe dla §5/§7: postulat wykluczenia w IIT 4.0 jest **ściśle binarny** ("zwycięzca bierze
wszystko", substraty o niższym φ wnoszą 0). Miękki mechanizm w = w₊ − w₋ z §7 jest świadomym,
nazwanym odejściem od tej binarności — po to, by dopuścić Σ<0.
