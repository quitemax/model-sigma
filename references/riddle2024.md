...
- DOI: https://doi.org/10.1093/nc/niae010
...
## Rola w Model Σ
Najbliższa koncepcyjnie praca: niezależnie proponuje liczenie Φ osobno na zagnieżdżonych
poziomach hierarchii i badanie stosunku Φ między poziomami. Model Σ trzeba jawnie od niej
odróżnić — NOW to sam stosunek Φ_ℓ/Φ_{ℓ-1}, bez ważenia funkcjonalnego w(ℓ), bez dynamiki
czasowej (Σ,Γ,A) i bez mechanizmu wykluczenia.

Uwaga: w poprzedniej wersji bibliografii ta pozycja była błędnie przypisana "Fink, S. B."
(klucz `fink2024`); poprawny autor to Riddle & Schooler — patrz `notes/citations.md`.
