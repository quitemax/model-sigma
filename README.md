...
- [`paper/`](paper/)
  - [`model_sigma.md`](paper/model_sigma.md) — pełna wersja robocza (19 sekcji), **źródło prawdy**
  - [`sigma_model_en.tex`](paper/sigma_model_en.tex) / [`sigma_model_pl.tex`](paper/sigma_model_pl.tex) — źródła LaTeX (EN / PL)
